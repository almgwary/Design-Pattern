/**
 * Design Pattern : Business_Delegate   Pattern [behavioral   pattern]
 * Author      : Almgwary
 * Date        : 28-Mar-2016
 * Thin        : --M
 **/
// Business_Delegate Pattern is used to decouple presentation tier and business tier. It is basically use to reduce communication or remote lookup functionality to business tier code in presentation tier code. In business tier we have following entities.
